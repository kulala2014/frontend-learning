...
EvilCircle.prototype.collisionDetect = function() {
    ...
    let existBall = balls.filter(item => item.exists === true);
    result.textContent = `还剩${existBall.length} 个球`;
}
...
let eCricle = new EvilCircle(random(20, width - 20), random(20, height - 20), true);
eCricle.setControls();
